...
public class HomePage extends JFrame {
	...
	private Border loweredBorder = BorderFactory.createBevelBorder(BevelBorder.LOWERED, new Color(255, 200, 109),
			new Color(255, 200, 109));
	 ...
	 * 
	 * @param list - Integer array list that creates JPanels to the height of the
